...
namespace TrackerLibrary
{
    ...
    {   
        ...
        // Check if it big enough - if not, add in byes (automatic win) - 2*2*2*2 - 2^4
        ...
        private static void CheckEndTournament(this TournamentModel model)
        {
            bool end = true;
        ...
        private static void MarkWinnerInMatchups(List<MatchupModel> models)
        {
            ...
            foreach (MatchupModel m in models)
            {
                // Checks for bye/free pass entry
                ...
                if (greaterWins == "0")
                {
                    ...
                    {
                        throw new Exception("Tie game invalid. Please play a rematch.");
                    }
                }
                else
                {
